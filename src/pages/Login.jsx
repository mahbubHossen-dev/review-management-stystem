    ...
    return (
        <div className='bg-[#F3F4F6] my-12'>
            <div className="card bg-base-100 w-full max-w-md mx-auto shrink-0 shadow-2xl">
                ...
                <p className='text-center text-gray-500 py-4'>Don&apos;t have an account?  <Link to='/register' state={location.state} className='font-medium border-b-2 font-bold'>Register here</Link></p>
